            ...
            <tbody>
                <?php
                    ...
                    while($row_data = mysqli_fetch_assoc($sql_data_result)){
                        echo "<tr>
                                    <td>".htmlspecialchars($row_data['ime'])."</td>
                                    <td>".htmlspecialchars($row_data['imeEng'])."</td>
                                    <td>".htmlspecialchars($row_data['cijena'])."</td>
                                    <td>
                                        <a href='details.php?id=".htmlspecialchars($row_data['id'])."'>
                                            <button class='btn btn-primary'>Pregled</button>    
                                        </a>                                        
                                    </td>
                                </tr>";
                    }
